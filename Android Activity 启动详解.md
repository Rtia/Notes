...
- [【Android Activity 启动详解】](#android-activity-%E5%90%AF%E5%8A%A8%E8%AF%A6%E8%A7%A3)
- [一、Activity的创建过程](#%E4%B8%80activity%E7%9A%84%E5%88%9B%E5%BB%BA%E8%BF%87%E7%A8%8B)
  - [step 1. Activity.startActivtiy()](#step-1-activitystartactivtiy)
  - [step2. Instrumentation.execStartActivity()](#step2-instrumentationexecstartactivity)
  - [step3. ActivityManagerNative](#step3-activitymanagernative)
    - [① ActivtiyManagerNative.getDefault().startActivity()](#%E2%91%A0-activtiymanagernativegetdefaultstartactivity)
    - [② ActivtiyManagerProxy.startActivity()](#%E2%91%A1-activtiymanagerproxystartactivity)
  - [step4. ActivityManagerService](#step4-activitymanagerservice)
  - [step5. ActivityStackSupervisor.startActivityMayWait()](#step5-activitystacksupervisorstartactivitymaywait)
  - [step6. ActivityStackSupervisor.startActivityLocked()](#step6-activitystacksupervisorstartactivitylocked)
  - [step7 : ActivityStackSupervisor.startActivityUncheckedLocked()](#step7--activitystacksupervisorstartactivityuncheckedlocked)
  - [step8 : ActivityStack.startActivityLocked()](#step8--activitystackstartactivitylocked)
  - [step9 : ActivityStackSupervisor.resumeTopActivitiesLocked()](#step9--activitystacksupervisorresumetopactivitieslocked)
  - [step10 : ActivityStack.resumeTopActivityLocked()](#step10--activitystackresumetopactivitylocked)
  - [step11：ActivityStackSupervisor.startSpecificActivityLocked()](#step11activitystacksupervisorstartspecificactivitylocked)
  - [step12: ActivityManagerService.startProcessLocked()](#step12-activitymanagerservicestartprocesslocked)
  - [step13: ActivityThread](#step13-activitythread)
  - [step14: ActivityManagerProxy.attachApplication() （ActivityManagerNative内部类）](#step14-activitymanagerproxyattachapplication-activitymanagernative%E5%86%85%E9%83%A8%E7%B1%BB)
  - [step15: ActivityManagerService.attachApplication()](#step15-activitymanagerserviceattachapplication)
  - [step16: ActivityStackSupervisor.attachApplicationLocked(ProcessRecord)](#step16-activitystacksupervisorattachapplicationlockedprocessrecord)
  - [★★★step17: ActivityStackSupervisor.realStartActivityLocked()](#%E2%98%85%E2%98%85%E2%98%85step17-activitystacksupervisorrealstartactivitylocked)
  - [step18: ApplicationThread.scheduleLaunchActivity()](#step18-applicationthreadschedulelaunchactivity)
  - [step19:ActivityThread.H](#step19activitythreadh)
  - [step20:ActivityThread.handleLaunchActivity(r, null)](#step20activitythreadhandlelaunchactivityr-null)
  - [step21: ActivityThread.performLaunchActivity()](#step21-activitythreadperformlaunchactivity)
  - [总结：](#%E6%80%BB%E7%BB%93)
  - [源码工程：](#%E6%BA%90%E7%A0%81%E5%B7%A5%E7%A8%8B)
- [二、layout的inflate过程](#%E4%BA%8Clayout%E7%9A%84inflate%E8%BF%87%E7%A8%8B)
  - [step1.Activity.setContentView()](#step1activitysetcontentview)
  - [step2. PhoneWindow.setContentView()](#step2-phonewindowsetcontentview)
  - [step3. PhoneWindow.installDecor(）](#step3-phonewindowinstalldecor)
  - [step 4. PhoneWindow.generateLayout(mDecor )](#step-4-phonewindowgeneratelayoutmdecor-)
    - [mDecor 、mContentRoot 、mContentParent](#mdecor-mcontentroot-mcontentparent)
  - [step5. LayoutInflater.inflate()](#step5-layoutinflaterinflate)
  - [step6. LayoutInflater.createViewFromTag()](#step6-layoutinflatercreateviewfromtag)
  - [step7. LayoutInflater.rInflate()](#step7-layoutinflaterrinflate)
  - [总结](#%E6%80%BB%E7%BB%93)
- [三、View的显示过程measure、layout、draw](#%E4%B8%89view%E7%9A%84%E6%98%BE%E7%A4%BA%E8%BF%87%E7%A8%8Bmeasurelayoutdraw)
    - [PhoneWindow：](#phonewindow)
    - [WindowManager：](#windowmanager)
    - [WindowManagerGlobal：](#windowmanagerglobal)
    - [WindowManagerService：](#windowmanagerservice)
  - [step1：ActivityThread.handleResumeActivity()](#step1activitythreadhandleresumeactivity)
  - [step2：WindowManagerGlobal.addView()](#step2windowmanagerglobaladdview)
  - [step3：ViewRootImpl.setView()](#step3viewrootimplsetview)
  - [step4：ViewRootImpl.performTraversals()](#step4viewrootimplperformtraversals)
  - [step5: ViewRootImpl.performMeasure()控件测量过程](#step5-viewrootimplperformmeasure%E6%8E%A7%E4%BB%B6%E6%B5%8B%E9%87%8F%E8%BF%87%E7%A8%8B)
  - [step6: View.measure()](#step6-viewmeasure)
    - [measure() VS onMeasure()](#measure-vs-onmeasure)
  - [step7: FrameLayout.onMeasure()](#step7-framelayoutonmeasure)
  - [step8：ViewRootImpl.performLayout()请求布局过程](#step8viewrootimplperformlayout%E8%AF%B7%E6%B1%82%E5%B8%83%E5%B1%80%E8%BF%87%E7%A8%8B)
  - [step9：View.layout()](#step9viewlayout)
    - [layout() VS onLayout()](#layout-vs-onlayout)
  - [step10：DecorView .onLayout()](#step10decorview-onlayout)
  - [step11：FrameLayout .onLayout()](#step11framelayout-onlayout)
  - [step12：ViewRootImpl.performDraw()控件绘制过程](#step12viewrootimplperformdraw%E6%8E%A7%E4%BB%B6%E7%BB%98%E5%88%B6%E8%BF%87%E7%A8%8B)
  - [step13：DecorView.draw()](#step13decorviewdraw)
  - [step14：View.draw()](#step14viewdraw)
  - [step15：DecorView.onDraw()](#step15decorviewondraw)
  - [step16：ViewGroup.dispatchDraw()](#step16viewgroupdispatchdraw)
  - [参考源码工程：](#%E5%8F%82%E8%80%83%E6%BA%90%E7%A0%81%E5%B7%A5%E7%A8%8B)
